...
// Variable: GET_ORDERS_QUERY
// Query: *[            _type == "order"            && clerkUserId == $userId        ] | order(orderDarw desc) {            ...,            products[]{                ...,                product->            }        }
export type GET_ORDERS_QUERYResult = Array<{
  _id: string;
  _type: "order";
  _createdAt: string;
  _updatedAt: string;
...
// Source: ./sanity/lib/products/getProductsByCateggory.ts
...
// Source: ./sanity/lib/sales/getSalesDetails.ts
// Variable: SALE_DETAILS_QUERY
// Query: *[            _type == "sale"            && isActive == true            && couponCode == $couponCode        ] | order(validFrom desc)[0]
export type SALE_DETAILS_QUERYResult = {
  _id: string;
  _type: "sale";
  _createdAt: string;
  _updatedAt: string;
